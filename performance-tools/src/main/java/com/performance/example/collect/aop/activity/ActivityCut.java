package com.performance.example.collect.aop.activity;

import android.app.Activity;
import android.text.TextUtils;
import com.performance.example.config.collectconfig.CollectActivityConfig;
import com.performance.example.core.activity.ActivityCore;
  ...
  public Object activityOnXXXOperate(ProceedingJoinPoint proceedingJoinPoint){
    ...
    try {
      ...
      if (!TextUtils.isEmpty(activityName) && !TextUtils.isEmpty(sign) && sign.contains(activityName)){
        ...
        ActivityCore.onLifeCycleOperate(activity,startTime, methodName);
      }
